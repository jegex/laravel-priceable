# Laravel package for multi-currency price management. Easily support fiat and crypto using the HasPrices trait. Includes dedicated models for currencies and prices to seamlessly handle exchange rates, multi-currency products, and flexible pricing architectures in any application. Lightweight, powerful, and developer-friendly.
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-priceable.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-priceable)
...
```bash
php artisan vendor:publish --tag="laravel-priceable-views"
```

## Usage

```php
$laravelPriceable = new Jegex\LaravelPriceable();
echo $laravelPriceable->echoPhrase('Hello, Jegex!');
```
